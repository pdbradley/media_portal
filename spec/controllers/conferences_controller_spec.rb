...
RSpec.describe ConferencesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested conference as @conference" do
      conference = Conference.create! valid_attributes
      get :show, params: {id: conference.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested conference as @conference" do
      conference = Conference.create! valid_attributes
      get :edit, params: {id: conference.to_param}, session: valid_session
      expect(assigns(:conference)).to eq(conference)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Conference" do
        expect {
          post :create, params: {conference: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved conference as @conference" do
        post :create, params: {conference: invalid_attributes}, session: valid_session
        expect(assigns(:conference)).to be_a_new(Conference)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested conference" do
        conference = Conference.create! valid_attributes
        put :update, params: {id: conference.to_param, conference: new_attributes}, session: valid_session
        conference.reload
      ...
      it "assigns the requested conference as @conference" do
        conference = Conference.create! valid_attributes
        put :update, params: {id: conference.to_param, conference: valid_attributes}, session: valid_session
        expect(assigns(:conference)).to eq(conference)
      end
    ...
    context "with invalid params" do
      it "assigns the conference as @conference" do
        conference = Conference.create! valid_attributes
        put :update, params: {id: conference.to_param, conference: invalid_attributes}, session: valid_session
        expect(assigns(:conference)).to eq(conference)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested conference" do
      conference = Conference.create! valid_attributes
      expect {
        delete :destroy, params: {id: conference.to_param}, session: valid_session
      }.to change(Conference, :count).by(-1)
    end
